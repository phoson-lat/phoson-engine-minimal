...
class FileTool(BaseTool):
    ...
    def run(self, *args: Any, **kwargs: Any) -> Any:
        """Not used directly; individual methods are exposed."""
        pass
    ...
    def patch_file(
        self, path: str, old_content: str, new_content: str, replace_all: bool = False
    ) -> str:
...
def read_file(
    ...
    return _ft.read_file(path, start_line, end_line)


@tool
def write_file(path: str, content: str) -> str:
    return _ft.write_file(path, content)
...
def patch_file(
    ...
    return _ft.patch_file(path, old_content, new_content, replace_all)


@tool
def list_dir(path: str = ".") -> str:
    return _ft.list_dir(path)
