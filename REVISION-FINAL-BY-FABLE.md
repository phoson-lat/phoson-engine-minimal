...
| **F-21** | Sin Grep ni Glob nativos; la única navegación es `list_dir` (profundidad 3, sin tope, sin `.gitignore`) y `bash`. `read_file` no devuelve números de línea. | `files.py:85-109, 113` | 🟠 gap SOTA | Fable | ✅ verificado · **nuevo** · issues #180, #181 · **parcial** (#180): `read_file` ahora `cat -n`; grep/glob nativos siguen en #181. |
